...
En effet, en terme de résultat, l'algorithme de Christofides nous donne un chemin optimisé de 3556 Km là où l'algorithme génétique varie entre 4000 et 6300 Km pour le chemin le plus optimisé après 100 génération.  

En terme d'efficacité d'algorithme, l'algorithme génétique est beaucoup plus lourd et donc plus long a exécuter (22.73 secondes) et fait aussi beaucoup plus d'appel de fonctions (13 060 031 appels).  

L'algorithme de Christofides est beaucoup plus rapide (0.04 secondes) et fait beaucoup moins d'appel de fonctions (25 700 appels).  
